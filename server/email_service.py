...
def send_verification_email(email, token):
    ...
    if not from_email or not email_app_password:
        print("send_verification_email: missing FROM_EMAIL or EMAIL_APP_PASSWORD", flush=True)
        return
    ...
    try:
        ...
        print(f"send_verification_email failed: {e}", flush=True)
...
def send_email_change_verification_email(email, token):
    ...
    if not from_email or not email_app_password:
        print("send_email_change_verification_email: missing FROM_EMAIL or EMAIL_APP_PASSWORD", flush=True)
        return
    ...
    try:
        ...
        print(f"send_email_change_verification_email failed: {e}", flush=True)
...
def send_forgot_password_email(email, token):
    ...
    if not from_email or not email_app_password:
        print("send_forgot_password_email: missing FROM_EMAIL or EMAIL_APP_PASSWORD", flush=True)
        return
    ...
    try:
        ...
        print(f"send_forgot_password_email failed: {e}", flush=True)
